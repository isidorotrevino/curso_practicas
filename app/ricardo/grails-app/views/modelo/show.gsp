...
<html>
    ...
    <body>
        ...
        <div id="show-modelo" class="content scaffold-show" role="main">
            ...
            <f:display bean="modelo" />
            <g:form resource="${this.modelo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.modelo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
