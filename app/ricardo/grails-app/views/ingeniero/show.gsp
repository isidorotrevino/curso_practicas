...
<html>
    ...
    <body>
        ...
        <div id="show-ingeniero" class="content scaffold-show" role="main">
            ...
            <f:display bean="ingeniero" />
            <g:form resource="${this.ingeniero}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.ingeniero}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
